...
<div class="d-block d-lg-none">
    <div class="row">
        <div class="col-12">
            <div class="view">
                <img src="{{ asset('image/asset/1.png') }}" class="w-100 h-100">
                <div class="mask pattern-1 flex-center waves-effect waves-light back-color-overlay">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-12">
                                    <span class="text-white" style="font-size:30px; font-weight:600">
                                        Stabilize your body
                                        <br />
                                        for a productive life
                                    </span>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-12">
                <iframe width="100%" src="https://www.youtube.com/embed/jfEB9l05Zbg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-lg-12">
    ...
    <div class="back-color mt-5 pb-4">
        <div class="row">
            <div class="col-12">
                <img src="{{ asset('image/asset/why.png') }}" class="w-100">
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-6">
                    <span class="badge bg-white rounded-pill z-depth-0 font-color pt-2 pb-2 pr-3 pl-3 btn-block">Stronger</span>
                </div>
                <div class="col-6">
                    <span class="badge bg-white rounded-pill z-depth-0 font-color pt-2 pb-2 pr-3 pl-3 btn-block">No Pain</span>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-6">
                    <span class="badge bg-white rounded-pill z-depth-0 font-color pt-2 pb-2 pr-3 pl-3 btn-block">More Agile</span>
                </div>
                <div class="col-6">
                    <span class="badge bg-white rounded-pill z-depth-0 font-color pt-2 pb-2 pr-3 pl-3 btn-block">Better Posture</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card rounded-0">
                        <div class="card-body p-0">
                            ...
                            <div class="container">
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <span style="font-size:25px; font-weight:500" class="font-color">Body Shaping</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <span>
                                            From IDR <span class="font-color" style="font-weight:600">6 Mio</span> <span style="font-size:10px;">Per 10x Visits</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-12">
                                    <button type="button" class="btn btn-md rounded-0 z-depth-0 back-color text-white m-0 btn-block">
                                        Join Now
                                    </button>
                                </div>
                            </div>
    ...
    <div class="back-color pt-3 pb-3">
        <div class="container">
            <div class="row">
            ...
            <div class="row mt-2">
                <div class="col-lg-12 d-flex justify-content-center">
                    <span style="font-size:25px; font-weight:700" class="text-white">Andry</span>
                </div>
            </div>
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <span style="font-size:18px; font-weight:500" class="text-white">Founder & CEO</span>
                </div>
            </div>
            <div class="row">
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <button type="button" class="btn btn-md z-depth-0 rounded-0 p-0 text-white">
                        <i class="fab fa-instagram"></i>
                    </button>
                    <button type="button" class="btn tbn-md z-depth-0 rounded-0 p-0 text-white">
            ...
            <div class="row mt-2">
                <div class="col-12 d-flex justify-content-center">
                    <span style="font-size:25px; font-weight:700" class="text-white">Karen</span>
                </div>
            </div>
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <span style="font-size:18px; font-weight:500" class="text-white">Coach</span>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center align-items-center">
                    <button type="button" class="btn btn-md z-depth-0 p-0 rounded-0 text-white">
                        <i class="fab fa-instagram"></i>
                    </button>
                    <button type="button" class="btn btn-md z-depth-0 p-0 rounded-0 text-white">
                        <i class="fab fa-youtube"></i>
            ...
            <div class="row mt-2">
                <div class="col-lg-12 d-flex justify-content-center">
                    <span style="font-size:25px; font-weight:700" class="text-white">Imelda</span>
                </div>
            </div>
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
    ...
    <div class="container">
        <div class="row mt-3">
            <div class="col-12 d-flex justify-content-center">
                <span style="font-size:20px; font-weight:600" class="font-color">What They Say about Body Gravity</span>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-12">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <span style="font-size:20px; font-weight:600" class="font-color">Our Information</span>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-6">
                <div class="row">
                    <div class="col-12">
                        <span style="font-weight:500" class="font-color">LOCATION</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <span style="font-weight:500">Jl. Teuku Nyak Arif</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
            ...
            <div class="col-6">
                <div class="row">
                    <div class="col-12">
                        <span style="font-weight:500" class="font-color">CONTACT US</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <span style="font-weight:500">Phone: +62 811 877 2283</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <span style="font-weight:500">Email: admin@body-gravity.com</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <span style="font-weight:500">Email: bodygravityid@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-6">
                <div class="row">
                    <div class="col-12">
                        <span style="font-weight:500" class="font-color">OPENING HOURS</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        <span style="font-weight:500">Saturday - Monday 07:00 - 12:00</span>
                    </div>
                </div>
            </div>
            <div class="col-6">
