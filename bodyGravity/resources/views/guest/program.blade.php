...
<div class="d-block d-lg-none">
    <div class="row">
        <div class="col-12">
            <div class="view">
                ...
                <div class="mask pattern-1 waves-effect waves-light d-flex justify-content-center align-items-center">
                    <div class="container mt-5">
                        <span class="text-white" style="font-size:20px; font-weight:700">
                            PROGRAM FOR PUBLIC<br />
                            <span style="font-size:15px;">Get a better body posture by joining now</span>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="card rounded-0 p-0 z-depth-0 border">
                    <div class="card-body pt-0 pb-0 pl-0 pr-0">
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <span style="font-size:20px; font-weight:600" class="font-color">Body Shaping</span>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-12">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                    <span style="font-size:15px; font-weight:500" class="font-color">From IDR 6 Mio<span style="font-size:10px;"> per 10x visits</span></span>
                                </div>
                            </div>
                        </div> 
                        <div class="row mt-4">
                            <div class="col-12">
                                <button type="button" class="btn btn-lg btn-block back-color text-white m-0 rounded-0">
                                    Book Now
                                </button>
                            </div>
                        </div>
                ...
                <div class="card rounded-0 z-depth-0 border">
                    <div class="card-body p-0">
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <span style="font-size:20px; font-weight:600" class="font-color">Rehabilitation</span>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                    <span style="font-size:15px; font-weight:500;" class="font-color">From IDR 6 Mio <span style="font-size:10px;">per 10x Visit</span></span>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-12">
                                <button type="button" class="btn btn-lg back-color text-white rounded-0 btn-block">
                                    Book Now
                                </button>
                            </div>
                        </div>
                ...
                <div class="card rounded-0 z-depth-0 rounded-0 border">
                    <div class="card-body p-0">
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <span style="font-size:20px; font-weight:600" class="font-color">
                                        Children
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                    <span style="font-size:15px; font-weight:500;" class="font-color">From IDR 5 Mio<span style="font-size:10px;"> per 10x Visit</span></span>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-12">
                                <button type="button" class="btn btn-lg z-depth-0 rounded-0 btn-block back-color text-white">Book Now</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card rounded-0 z-depth-0 border">
                    <div class="card-body p-0">
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <span style="font-size:20px; font-weight:600" class="font-color">Senior</span>
                                </div>
                            </div>
                            <div class='row mt-4'>
                                <div class="col-lg-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                    <span style="font-weight:500; font-size:15px;" class="font-color">from IDR 7 Mio<span style="font-size:10px;"> per 10x visit</span></span>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-12">
                                <button type="button" class="btn btn-lg z-depth-0 rounded-0 btn-block back-color text-white">
                                    Book Now
                                </button>
                            </div>
                        </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="view">
                <img src="{{ asset('image/asset/1.png') }}" class="w-100">
                <div class="mask pattern-1 wafes-effect waves-light d-flex justify-content-center align-items-center">
                    <div class="container">
                        <span style="font-size:20px; font-weight:700" class="text-white">
                            Program For Coach<br />
                            <span style="font-size:15px;">Want to learn about Body Gravity? Come join our training</span>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class='container'>
                ...
                <div class="card z-depth-0 rounded-0 border">
                    <div class="card-body pt-0 pl-0 pr-0">
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <span style="font-size:20px; font-weight:600" class="font-color">Basic Program</span>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-lg-12">
                ...
                <div class="card z-depth-0 border rounded-0">
                    <div class="card-body pt-0 pr-0 pl-0">
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <span style="font-size:20px; font-weight:600" class="font-color">Intermediate Program</span>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-lg-12">
        ...
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="card z-depth-0 border rounded-0">
                    <div class="card-body pt-0 pl-0 pr-0 d-flex align-items-end flex-column">
                        <div class="row">
                            <div class="col-12">
                                <img src="{{ asset('image/asset/advance.jpg') }}" class="w-100">
                            </div>
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    <span style="font-size:20px; font-weight:600;" class="font-color">Advance Program</span>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-lg-12">
